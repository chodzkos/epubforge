...
class CodeEditor(QWidget):
    ...
    def _build_search_bar(self) -> QWidget:
        ...
        self.search_field.setToolTip(_("Wyszukaj tekst w bieżącym edytorze (Ctrl+F)"))
        ...
        self.prev_button.setToolTip(_("Przejdź do poprzedniego trafienia (Shift+F3)"))
        self.prev_button.clicked.connect(self.find_previous)
        row.addWidget(self.prev_button)
        self.next_button = QPushButton(_("Następny"))
        self.next_button.setToolTip(_("Przejdź do następnego trafienia (F3)"))
